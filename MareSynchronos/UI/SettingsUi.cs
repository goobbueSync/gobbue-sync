...
public class SettingsUi : WindowMediatorSubscriberBase
{
    ...
    public SettingsUi(ILogger<SettingsUi> logger,
        ...
        DalamudUtilService dalamudUtilService, HttpClient httpClient) : base(logger, mediator, "Goobbue Sync Settings", performanceCollector)
    {
    ...
    private void DrawFileStorageSettings()
    {
        ...
        UiSharedService.TextWrapped("Goobbue stores downloaded files from paired people permanently. This is to improve loading performance and requiring less downloads. " +
        ...
        {
            ImGui.SameLine();
            using var id = ImRaii.PushId("goobbueMonitor");
            if (_uiShared.IconTextButton(FontAwesomeIcon.ArrowsToCircle, "Try to reinitialize Monitor"))
            {
        ...
        UiSharedService.AttachToolTip("You normally do not need to do this. THIS IS NOT SOMETHING YOU SHOULD BE DOING TO TRY TO FIX SYNC ISSUES." + Environment.NewLine
            ...
            + "Goobbue's storage is self-clearing and will not surpass the limit you have set it to." + Environment.NewLine
    ...
    private void DrawPerformance()
    {
        ...
        _uiShared.DrawHelpText("Goobbue will print a warning in chat once per session of meeting those people. Will not warn on players with preferred permissions.");
        using (ImRaii.Disabled(!warnOnExceedingThresholds && !showPerformanceIndicator))
        {
            ...
            _uiShared.DrawHelpText("Goobbue will also print warnings and show performance indicator for players where you enabled preferred permissions. If warning in general is disabled, this will not produce any warnings.");
        }
    ...
    private void DrawSettingsContent()
    {
        ...
        ImGui.SameLine();
        if (ImGui.Button("Goobbue Sync Discord"))
        {
