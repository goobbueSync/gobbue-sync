...
{
    public const string CustomAllTag = "Goobbue_All";
    public const string CustomOfflineTag = "Goobbue_Offline";
    public const string CustomOfflineSyncshellTag = "Goobbue_OfflineSyncshell";
    public const string CustomOnlineTag = "Goobbue_Online";
    public const string CustomUnpairedTag = "Goobbue_Unpaired";
    public const string CustomVisibleTag = "Goobbue_Visible";
