...
public class CensusPopupHandler : IPopupHandler
{
    ...
    public void DrawContent()
    {
        ...
        {
            start = ImGui.GetCursorPosY() - ImGui.CalcTextSize("Goobbue Census Data").Y;
            UiSharedService.TextWrapped("Goobbue Census Participation");
        }
        ...
        ImGui.Separator();
        UiSharedService.TextWrapped("Goobbue Census is a data collecting service that can be used for statistical purposes. " +
