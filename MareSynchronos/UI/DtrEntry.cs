...
public sealed class DtrEntry : IDisposable, IHostedService
{
    ...
    private IDtrBarEntry CreateEntry()
    {
        ...
        var entry = _dtrBar.Get("Goobbue Sync");
    ...
    private void Update()
    {
        ...
        if (_apiController.IsConnected)
        {
            ...
            if (pairCount > 0)
            {
                ...
                tooltip = $"Goobbue Sync: Connected{Environment.NewLine}----------{Environment.NewLine}{string.Join(Environment.NewLine, visiblePairs)}";
                colors = _configService.Current.DtrColorsPairsInRange;
            }
            else
            {
                tooltip = "Goobbue Sync: Connected";
        ...
        {
            text = "\uE044 \uE04C";
            tooltip = "Goobbue Sync: Not Connected";
