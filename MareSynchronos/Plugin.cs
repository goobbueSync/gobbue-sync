...
public sealed class Plugin : IDalamudPlugin
{
        ...
        ISigScanner sigScanner)
    {
        ...
        .ConfigureLogging(lb =>
        {
            ...
            lb.AddFile(Path.Combine(traceDir, $"goobbue-trace-{DateTime.Now:yyyy-MM-dd-HH-mm-ss}.log"), (opt) =>
            {
                opt.Append = true;
        ...
        {
            collection.AddSingleton(new WindowSystem("GoobbueSync"));
            collection.AddSingleton<FileDialogManager>();
            collection.AddSingleton(new Dalamud.Localization("GoobbueSync.Localization.", "", useEmbedded: true));
            ...
            collection.AddSingleton((s) =>
            {
                ...
                httpClient.DefaultRequestHeaders.UserAgent.Add(new ProductInfoHeaderValue("GoobbueSync", ver!.Major + "." + ver!.Minor + "." + ver!.Build));
                return httpClient;
            });
